...
N -> "holmes" | "home" | "i" | "mess" | "paint" | "palm" | "pipe" | "she" | "the home"
...
def preprocess(sentence):
    ...
    return [entry.lower() for entry in tokens if test.search(entry)]
...
def np_chunk(tree):
    ...
    for subtree in tree.subtrees():
        ...
        if subtree.label() == "NP":
            # Check if this NP does not contain any other NP subtrees
